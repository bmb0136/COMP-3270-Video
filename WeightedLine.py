"""
Taken from:
https://github.com/mutable-learning/manim-weighted-line/blob/main/src/manim_weighted_line/weighted_line.py
Since I cannot pip install it because my python is too new
"""
